    ...
    <body>
        ...
        <div class="container mt-3">
            ...
            <div class="row mb-3 align-items-center">
                <div class="col-md-8">
                    <p class="mb-0">Liste des partenaires</p>
                </div>
            ...
            <table class="table table-bordered text-center">
                ...
                <tbody>
                    @foreach ($partenaires as $key => $value)
                        <tr>
                            <td>
                                <img src="{{ asset('assets/uploads/'.$value->image) }}" alt="Course Image" class="img-fluid rounded-circle" style="width: 100px; height: 100px;">
                            </td>
                            ...
                            <td class="action-icons">
                                ...
                                <a href="{{ url('partenaires/' . $value->id . '/destroy') }}"
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form id="societeForm" action="{{ url('partenaires/' . $value->id . '/update') }}"
                                            ...
                                            <div class="mb-3">
                                                <label for="nom_entreprise" class="form-label">Logo</label>
        ...
        <div class="modal fade" id="modalEnregistrement" tabindex="-1" aria-labelledby="modalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="modalLabel">AJOUTER UN PARTENAIRE</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <form action="{{ url('partenaires') }}" method="post" enctype="multipart/form-data">
                            @csrf
